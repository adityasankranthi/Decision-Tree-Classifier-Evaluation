...
# Load dataset
data_44345 = datasets.fetch_openml(data_id=1020)
...
fpr_entropy, tpr_entropy, th_entropy = roc_curve(data_44345.target, y_scores_entropy[:, 1], pos_label="P")
...
fpr_gini, tpr_gini, th_gini = roc_curve(data_44345.target, y_scores_gini[:, 1], pos_label="P")
